...
public class MainChar extends Enemy{
    ...
    private static void drawSpawnImage(int where){
        switch(where){
            case 1: // door
                Music foot = new Music(Game.PREFIX + "footsteps.wav");
                foot.play(true);
                Game.draw(Game.back.getX(), Game.back.getY(), Game.PREFIX + "Images/Backgrounds/BackgroundAM_Fz_openedDoor.jpg");
            ...
            case 2: // vent
                ...
                vent.play(true);
                Game.draw(Game.back.getX(), Game.back.getY(), Game.PREFIX + "Images/Backgrounds/BackgroundAM_Fz_Vent.jpg");
            ...
            case 3: // window
                ...
                window.play(true);
                Game.draw(Game.back.getX(), Game.back.getY(), Game.PREFIX + "Images/Backgrounds/BackgroundAM_Fz_window.jpg");
    ...
    public void jumpscare(){
            ...
            Game.draw(Game.back.getX(), Game.back.getY(), Game.PREFIX + "Images/Backgrounds/BackgroundAM_opened.jpg");
            soundJump.play(true);
