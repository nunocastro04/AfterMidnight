package org.codeforall.AfterMidnight.Objects.flash;
...
public class Flash {
    ...
    public void activateFlash() {
        if (remainingFlashes > 0) {
            flash = new Picture(Game.back.getX(), Game.back.getY(), Game.PREFIX + "Images/Utils/teste flash.jpg");
            flash.draw();
            flashUsed = true;
